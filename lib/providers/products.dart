...
class Products with ChangeNotifier{
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    var url =
        'https://fluttershop-app.firebaseio.com/products.json?auth=$authToken&$filterString';
    try {
  ...
  Future<void> addProduct(Product product) async {
    final url = 'https://fluttershop-app.firebaseio.com/products.json?auth=$authToken';
